...
CREATE TABLE installation_adapter_status (
  ...
  CONSTRAINT chk_adapter_runtime_status
    CHECK (runtime_status IN ('UNDETECTED', 'DETECTED', 'NEEDS_PERMISSION', 'CONFIGURING',
                              'ACTIVE', 'DEGRADED', 'ERROR', 'DISABLED'))
) ENGINE = InnoDB;
...
CREATE TABLE usage_events (
  ...
  source_cursor_hmac       BINARY(32) NOT NULL,
  raw_fingerprint_hmac     BINARY(32) NOT NULL,
  ...
  token_tool               BIGINT UNSIGNED NULL,
