...
mod tests {
    ...
    fn release_jump_and_resume() {
        // The old Mac 0.1.27 package predates reconstruction; 0.1.28 must
        // reconstruct it, while keeping progress from Windows 0.1.27 tests.
        assert_eq!(required_release("0.1.28", "").as_deref(), Some("0.1.27"));
        assert_eq!(required_release("0.1.28", "0.1.27"), None);
        assert_eq!(
